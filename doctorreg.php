...
<script>
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" action="thanksreg.php?edit=doctor" name="RegForm" onsubmit="return myfunction()" method="POST" enctype="multipart/form-data">
				...
				<label class="label-input100" for="doctorcerti">Upload Doctor Certificate *</label>
				<div class="wrap-input100">
				    <input type="file" name="fileToUpload" id="fileToUpload" class="custom-file-upload" required>
					<span class="focus-input100"></span>
				</div>
				
				<label class="label-input100" for="specialization">Enter specialization *</label>
				<div class="wrap-input100">
					<select class="input100" name="specialization" required>
						<option value="">---select---</option>
